      ...
      <Card>
        ...
        <Card.Body>
          <Form.Group>
            ...
            <Form.Control name="ID_Potongan" value={Potongan.ID_Potongan || ""} onChange={handleInput} />
          </Form.Group>
          <Form.Group className="mt-3">
            <Form.Label>Nama Potongan</Form.Label>
            <Form.Control name="Nama_Potongan" value={Potongan.Nama_Potongan || ""} onChange={handleInput} />
          </Form.Group>
        </Card.Body>
      </Card>
    </NavigationWidget>
